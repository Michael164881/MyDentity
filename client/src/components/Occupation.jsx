...
const Occupation = () => {
        ...
        try {
            ...
            if (data && typeof data === 'object') {
                setFormData({
                    ...
                    yearsOfExperience: data.yearsOfExperience ? data.yearsOfExperience.toString() : ''
                });
  ...
  const handleSubmit = async () => {
    if (!formData.occupation || !formData.employer || !formData.yearsOfExperience) {
    ...
    try {
        ...
        console.log("Data saved successfully:", {
          householdSize: formData.occupation,
          householdIncome: formData.employer,
          dependents: formData.yearsOfExperience
        });
        setIsLoading(false);
    } catch (error) {
