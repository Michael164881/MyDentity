...
const Household = () => {
    ...
    try {
        ...
        try {
            ...
            if (data && typeof data === 'object') {
                setFormData({
                  householdSize: data.householdSize ? data.householdSize.toString() : '',
                  householdIncome: data.householdIncome ? data.householdIncome.toString() : '',
                  dependents: data.dependents ? data.dependents.toString() : ''
                });
  ...
  const handleSubmit = async () => {
    if (!formData.householdSize || !formData.householdIncome || !formData.dependents) {
