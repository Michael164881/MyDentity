...
const Relief = () => {
        ...
        try {
            ...
            if (data && typeof data === 'object') {
                setFormData({
                    ...
                    reliefDetails: data.reliefDetails || '',
                    reliefAmount: data.reliefAmount ? data.reliefAmount.toString() : '',
                });
  ...
  const handleSubmit = async () => {
    if (!formData.reliefType || !formData.reliefDetails || !formData.reliefAmount) {
    ...
    try {
        ...
        console.log("Data saved successfully:", {
          ...
          reliefDetails: formData.reliefDetails,
          reliefAmount: formData.reliefAmount
        });
        setIsLoading(false);
    } catch (error) {
